"""
Question 5 — Python: Find and Fix the Bug  [Short Answer — Write Code]
...
It runs without crashing, but it returns the wrong answer.
    ...
    # Expected: 3  (the evens are 2, 4, 6)
...
(a) What does the buggy version actually return for [1, 2, 3, 4, 5, 6], and why?
